...
```{r load_data}
subject_df <- load_subject('data/psql/subject.csv')
reading_so2_df <- load_reading('data/psql/reading_so2.csv')
reading_spo2_df <- load_reading('data/psql/reading_spo2.csv')
```
