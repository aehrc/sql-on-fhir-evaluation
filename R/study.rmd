...
reading_so2_df <- load_reading('data/fhir_mimic-2.2/reading_so2.csv')
reading_spo2_df <- load_reading('data/fhir_mimic-2.2/reading_spo2.csv')
```
...
Like on the original paper, we found Black race was associated with a higher SpO2 for a given hemoglobin oxygen saturation, when controlling for age and the same was true for Asian and Hispanic patients.
